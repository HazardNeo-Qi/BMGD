...
# 新增，buffer
#buffer_size = 1281167#batch_size*100
buffer_size = 100000
...
# 新增，buffer
log_file_buffer = 'result/log/ResNet_50_v2_bmgd.txt'
...
train_data_path = '/database/datasets/ImageNet2012/train' #'/home1/dataset/ImageNet/ILSVRC2012_img_train'
test_data_path = '/database/datasets/ImageNet2012/val' #'/home1/dataset/ImageNet/ILSVRC2012_img_val'
